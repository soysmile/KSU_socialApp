...
class UserCell: UITableViewCell {
    ...
    @objc func removeLoaderForTextLabel()
    {
        //self.textLabel?.hideLoader()
        //self.textLabel?.relo
    }
    override func layoutSubviews() {
        super.layoutSubviews()
        //textLabel?.showLoader()
        //Timer.scheduledTimer(timeInterval: 5.0, target: self, selector: #selector(UserCell.removeLoaderForTextLabel), userInfo: nil, repeats: false)
